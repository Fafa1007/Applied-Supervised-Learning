...
f1_t_3 <- ggplot() + geom_line(data = df, aes(x = x, y = y)) + geom_vline(xintercept = max_F1_tau, color = "red", linetype = "dashed") + theme_minimal() + labs(x = "Tau", y = "F1 Score", title = "F1 Score Against Different Desician Rule Thresholds (Tau) for a KNN Model")
f1_t_3
...
text(
  x = FPR_knn + 0.15,    # Offset text slightly to the right
  y = TPR_knn - 0.08, 
